...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            numerical_columns = ["Age", "Height", "Duration", "Heart_Rate", "Body_Temp"]
            ...
            # Here we are handling missing value and use median because there are outlier in data.
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            drop_column_name = ["User_ID","Weight"]
            target_column_name = "Calories"
            #numerical_columns = ["Age", "Height", "Duration", "Heart_Rate", "Body_Temp"]
            #categorical_columns = ["Gender"]

            input_feature_train_df = train_df.drop(columns = drop_column_name)
            target_feature_train_df = train_df[target_column_name]

            input_feature_test_df = test_df.drop(columns = drop_column_name)
